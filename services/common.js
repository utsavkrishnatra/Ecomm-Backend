...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "bloggercanada143@gmail.com",
...
//    console.log(" I am about to send the mail!! to user with password",process.env.MAIL_PASSWORD);
//   let info = await transporter.sendMail({
//       from: '"utsify.co" <utsify@gmail.com>', // sender address
//       to,
//       subject,
//       text,
//       html
//     });
//     console.log("The data returned is;",info)
//   return info;  
// }
exports.sendMail = async function ({to = '', subject = '', text = '', html = ''}) {
  console.log(" I am about to send the mail!! to user with password", process.env.MAIL_PASSWORD);
